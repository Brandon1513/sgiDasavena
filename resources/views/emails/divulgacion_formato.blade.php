...
<head>
    <meta charset="UTF-8">
    <title>Actualización de formato divulgada</title>
</head>
                                ...
                                <tr>
                                    <td style="padding:38px 42px 34px 42px;">
                                        ...
                                        <p style="margin:14px 0 0; font-size:15px; line-height:1.7; color:#eadff0; max-width:540px;">
                                            Se ha finalizado una solicitud de actualización y el formato ya se encuentra divulgado dentro del sistema.
                                        </p>
                    ...
                    <tr>
                        <td style="padding:40px 42px 20px 42px;">
                            ...
                            <p style="margin:0 0 30px; font-size:15px; line-height:1.8; color:#5b6472;">
                                Se concluyó satisfactoriamente una solicitud de actualización de formato. A continuación se presenta el resumen principal del registro finalizado.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:22px 24px 12px 24px;">
                                        ...
                                        <h2 style="margin:8px 0 0; font-size:20px; line-height:1.3; color:#3a1844; font-weight:700;">
                                            Detalles del formato actualizado
                                        </h2>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:0 24px 24px 24px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#ffffff; border:1px solid #ebe5f0; border-radius:16px; overflow:hidden;">
                                            ...
                                            <tr>
                                                <td style="padding:15px 18px; border-bottom:1px solid #f0eaf4; font-size:13px; color:#7a8699; font-weight:700;">
                                                    Fecha de alta en el SGI
                                                </td>
                                                <td style="padding:15px 18px; border-bottom:1px solid #f0eaf4; font-size:14px; color:#1f2937; font-weight:600;">
                                                    {{ \Carbon\Carbon::parse($solicitud->fecha_alta_sgi)->format('d/m/Y') }}
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="padding:15px 18px; font-size:13px; color:#7a8699; font-weight:700; vertical-align:top;">
                                                    Observaciones del SGI
                                                </td>
                                                <td style="padding:15px 18px; font-size:14px; color:#1f2937; font-weight:600; line-height:1.7;">
                                                    {{ $solicitud->observaciones_sgi ?? 'Sin observaciones' }}
                                                </td>
                                            </tr>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:24px; background:#faf8fc; border:1px dashed #ddcfe3; border-radius:16px;">
                                <tr>
                                    <td style="padding:20px;">
                                        <p style="margin:0 0 10px; font-size:13px; line-height:1.5; color:#8b6b96; text-transform:uppercase; letter-spacing:1px; font-weight:700;">
                                            Medio de archivo
                                        </p>
                                        <p style="margin:0; font-size:14px; line-height:1.8; color:#5b6472;">
                                            El documento final puede ser consultado directamente desde el siguiente acceso:
                                        </p>
                                    </td>
                                </tr>
                            </table>
